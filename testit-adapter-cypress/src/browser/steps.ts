...
export const startTmsApiStep = (name: string) => reportStepStart(pushTmsStep(), name);

export const pushTmsStep = () => {
...
export const stopCurrentTmsApiStep = (status?: Status, statusDetails?: StatusDetails) =>
...
const stopTmsApiStepStackTip = (status: Status, statusDetails: StatusDetails) => {
