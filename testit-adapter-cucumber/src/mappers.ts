...
export interface AutotestPostWithWorkItemId extends AutoTestPostModel {
    workItemIds?: string[];
}

export function mapStatus(status: TestStepResultStatus): string {
    switch (status) {
...
export function mapBackground(background: Background): AutoTestStepModel {
    return {
...
export function mapScenario(
    ...
    if (tags.externalId === undefined) {
        return {
            ...
            name: scenario.name,
            projectId,
            workItemIdsForLinkWithAutoTest: undefined,
            shouldCreateWorkItem: undefined,
            links: undefined,
            namespace: undefined,
            classname: undefined,
            steps: undefined,
...
export function mapExamples(examples: Examples): AutoTestStepModel {
...
export function mapStep(step: Step): AutoTestStepModel {
    return {
