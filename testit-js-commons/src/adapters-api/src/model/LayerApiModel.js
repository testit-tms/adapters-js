...
class LayerApiModel {
    ...
    constructor(name, source) { 
        ...
        LayerApiModel.initialize(this, name, source);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of LayerApiModel.RequiredProperties) {
 ...
 * @member {String} name
 */
LayerApiModel.prototype['name'] = undefined;

/**
 * Source of the test pyramid layer.
 * @member {module:model/LayerSource} source
 */
LayerApiModel.prototype['source'] = undefined;
